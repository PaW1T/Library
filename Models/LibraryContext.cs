...
namespace Library.Models
{
    ...
    public class LibraryContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookReader>().HasKey(p => new { p.BookId, p.ReaderId });
        ...
        public DbSet<ReadersCard> ReaderCards { get; set; }
        public DbSet<BookReader> OrderBookReaders { get; set; }
    }
}